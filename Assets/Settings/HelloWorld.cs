...
public class HelloWorld : MonoBehaviour
{
    ...
    public Text versionConsole;
    public Text packageConsole;
    public Text packagesConsole;
    ...
    public string HTTPAddress = "http://10.24.9.240:8080/";
    ...
    void Start()
    {
        ...
        //downloadButton.onClick.AddListener(LoadAsset);
    ...
    void LoadAsset()
    {
        ...
        if(downloadButton)
        {
            assetPackage.LoadScene("Assets/Scenes/DownloadScene.unity");
        }
    ...
    IEnumerator GetRemoteVersion()
    {
        ...
        versionConsole.text = "远端资源版本为" + version;
    ...
    IEnumerator GetRemotePackages()
    {
        ...
        packageConsole.text = "Packages下载完成" + packagesSavePath;
        ...
        foreach (string packageName in packagesNames)
        {
            ...
            if (!Directory.Exists(remotePackagePath))
            {
                Directory.CreateDirectory(remotePackagePath);
            }
            ...
            packagesConsole.text += "Packages下载完成" + packageName + "\n";
            yield return new WaitForSeconds(1); // 等待1秒再显示下一个包名

            Debug.Log($"Packages下载完成{packageName}");
        }
